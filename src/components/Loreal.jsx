const Loreal = ({lorealProds}) => {

  return(
    <>
      <h2 className='subtitle' id='loreal'>L'Oreal</h2>
        <p style={{width:'85%'}}>En esta sección te mostramos los productos destacados en oferta de la sección de L'Oreal de Amazon, pero si buscas una marca en concreto tienes nuestra sección inicial que te mostrará sus productos.</p>
          <div className='productsCardsContainer'>
          {
            lorealProds.map((product, index) => {
              return(
