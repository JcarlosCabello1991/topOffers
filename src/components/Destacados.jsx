const Destacados = ({rows}) => {
  return(
    <>
    <h2 style={{width:'85%'}} className='subtitle' id='destacadas'>Ofertas destacadas en maquillaje</h2>
    <p style={{width:'85%'}}>En esta sección te mostramos los productos destacados en oferta de la sección de maquillaje de Amazon, pero si buscas una marca en concreto tienes nuestra sección inicial que te mostrará sus productos.</p>
