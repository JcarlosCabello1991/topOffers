const Nyx = ({nyxProds}) => {
  return(
    <>
      <h2 className='subtitle' id='nyx'>NYX</h2>
          <p style={{width:'85%'}}>En esta sección te mostramos los productos destacados en oferta de la sección de NYX de Amazon, pero si buscas una marca en concreto tienes nuestra sección inicial que te mostrará sus productos.</p>
          <div className='productsCardsContainer'>
          {
            nyxProds.map((product, index) => {
              return(
