const Anastasia = ({anastasiaProds}) => {

  return(
    <>
      <h2 className='subtitle' id='anastasia'>Anastasia</h2>
        <p style={{width:'85%'}}>En esta sección te mostramos los productos destacados en oferta de la sección de Anastasia de Amazon, pero si buscas una marca en concreto tienes nuestra sección inicial que te mostrará sus productos.</p>
          <div className='productsCardsContainer'>
          {
            anastasiaProds.map((product, index) => {
              return(
